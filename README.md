...
- ```IGNORE_PARAMETERS``` is a list of names of parameters to ignore when constructing presets on the fly. Can e.g. be used to exclude the "Device On" button normally included. Default ```[]```.
